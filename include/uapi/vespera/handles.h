...
#define HANDLE_TYPE_FIFO 0x1100000000000000UL
#define HANDLE_TYPE_SOCKET 0x1200000000000000ULL
#define HANDLE_TYPE_EVENTFD 0x1300000000000000ULL
#define HANDLE_TYPE_TIMERFD 0x1400000000000000ULL
#define HANDLE_TYPE_SIGNALFD 0x1500000000000000ULL
