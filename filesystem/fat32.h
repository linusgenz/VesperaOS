...
#define READ_DIR_MAX_ENTRIES 256
    ...
    private:
        ...
        bool WriteLFNEntries(const char* longName, const char* shortName, uint32_t dirCluster);
    ...
    void ExtractShortName(const char* rawName, char* shortNameBuffer, size_t bufferSize);
