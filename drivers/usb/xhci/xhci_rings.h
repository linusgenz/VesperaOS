...
public:
    ...
    [[nodiscard]] xhci_trb_t* get_virtual_base() const { return trbs_; }
    [[nodiscard]] uintptr_t get_physical_base() const { return physical_base_; }
    [[nodiscard]] uint8_t get_cycle_bit() const { return rcs_bit_; }
...
public:
    ...
    [[nodiscard]] uintptr_t get_physical_base() const { return physical_base_; }
    [[nodiscard]] uint8_t get_cycle_bit() const { return rcs_bit_; }
    [[nodiscard]] uint8_t get_doorbell_id() const { return doorbell_id_; }
