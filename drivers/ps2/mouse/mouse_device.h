...
*/
#ifndef VESPERAOS_MOUSE_DEVICE_H
#define VESPERAOS_MOUSE_DEVICE_H
...
public:
    ...
    explicit Ps2MouseDevice(Ps2Controller* controller);
    ~Ps2MouseDevice() override;
...
#endif //VESPERAOS_MOUSE_DEVICE_H