...
namespace AHCI{
    ...
    PortType CheckPortType(HBAPort* port){
        ...
        switch (port->signature){
            case SATA_SIG_ATAPI:
                global_renderer->print("SATAPI");
                global_renderer->new_line();
                return PortType::SATAPI;
            case SATA_SIG_ATA:
                global_renderer->print("SATA");
                                global_renderer->new_line();
                return PortType::SATA;
            case SATA_SIG_PM:
                global_renderer->print("PM");
                                global_renderer->new_line();
                return PortType::PM;
            case SATA_SIG_SEMB:
                global_renderer->print("SEMB");
                                global_renderer->new_line();
    ...
    AHCIDriver::AHCIDriver(PCI::PCIDeviceHeader* pciBaseAddress){
        ...
        global_renderer->print("AHCI Driver instance initialized");
        global_renderer->new_line();
